<template>
  <main class="w-full fixed top-0 left-0 z-40 bg-white">
    <!-- Mobile menu -->
            ...
            >
                    ...
                    >
                      <button
                        :class="[
                          ...
                          'flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-light'
                        ]"
                      >
                        {{ category.name }}
                      </button>
              ...
              <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                <div v-for="page in navigation.pages" :key="page.name" class="flow-root">
                  <a :href="page.href" class="-m-2 block p-2 font-light text-gray-900">{{
                    page.name
                  }}</a>
                </div>
              </div>
