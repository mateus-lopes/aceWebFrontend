              ...
              <div class="center">
                <PopoverGroup class="hidden lg:ml-8 lg:block lg:self-stretch">
                  <div class="flex h-full space-x-8">
                                  ...
                                  <div v-for="section in category.sections" :key="section.name">
                                    ...
                                    <ul role="list" :aria-labelledby="`${section.name}-heading`" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                      <li v-for="item in section.items" :key="item.name" class="flex">
                                        <a :href="item.href" class="hover:text-gray-800 hover:underline">{{ item.name }}</a>
                                      </li>
                                    </ul>
                                  </div>
                                </div>
                    ...
                    <a v-for="page in navigation.pages" :key="page.name" :href="page.href" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                      {{ page.name }}
                    </a>
                  </div>
                </PopoverGroup>
